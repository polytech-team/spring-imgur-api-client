...
import team.polytech.imgur.invoker.auth.Authentication;
import team.polytech.imgur.invoker.auth.ApiKeyAuth;
import team.polytech.imgur.invoker.auth.OAuth;
...
@Component("team.polytech.imgur.invoker.ApiClient")
public class ImgurApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "https://api.imgur.com";
    ...
    public ImgurApiClient(boolean anonymous) {
        this.restTemplate = buildRestTemplate();
    ...
    @Autowired
    public ImgurApiClient(RestTemplate restTemplate) {
        this.restTemplate = restTemplate;
        this.anonymous = false;
        init(false);
    }

    protected void init(boolean anonymous) {
        ...
        authentications.put("clientId", new ApiKeyAuth("header", "Authorization"));
        if (!anonymous) {
     ...
     */
    public ImgurApiClient setBasePath(String basePath) {
     ...
     * @return ApiClient this client
     */
    public ImgurApiClient setUserAgent(String userAgent) {
     ...
     * @return ApiClient this client
     */
    public ImgurApiClient addDefaultHeader(String name, String value) {
     ...
     * @return ApiClient this client
     */
    public ImgurApiClient addDefaultCookie(String name, String value) {
     ...
     * @return API client
     */
    public ImgurApiClient setDateFormat(DateFormat dateFormat) {
